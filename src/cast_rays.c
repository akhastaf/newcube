...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/11/06 13:43:48 by akhastaf          #+#    #+#             */
/*   Updated: 2020/11/06 14:18:38 by akhastaf         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_horz(int id)
{
	...
	g_horz.inter.x = g_player.pos.x + ((g_horz.inter.y - g_player.pos.y)
			/ tan(g_rays[id].angle));
...
void	init_vert(int id)
{
	...
	g_vert.inter.y = g_player.pos.y + ((g_vert.inter.x - g_player.pos.x)
			* tan(g_rays[id].angle));
